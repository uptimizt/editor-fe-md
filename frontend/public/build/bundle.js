...
var app = (function () {
    ...
    class ButtonGroup extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$r, create_fragment$r, safe_not_equal, { class: 2, size: 3, vertical: 4 });
    ...
    class Styles extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$9, create_fragment$9, safe_not_equal, { icons: 0 });
    ...
    const restApiParams = readable({}, function start(set) {
    ...
    const postUpdate = derived([id, title, status, content, md_editor_content], ([$id, $title, $status, $content, $md_editor_content], set) => {
    ...
    // (39:0) <Button color="primary" on:click={handleClick} block>
    function create_default_slot$5(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(39:0) <Button color=\\\"primary\\\" on:click={handleClick} block>",
    		ctx
    	});
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, postUpdate, $$value => $$invalidate(2, $postUpdate = $$value));
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<SaveButton> was created with unknown prop '${key}'`);
    	});
    ...
    function create_default_slot_1$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(53:0) <Label for=\\\"coverImage\\\">",
    		ctx
    	});
    ...
    // (55:0) <FormText color="muted">
    function create_default_slot$3(ctx) {
    	let t;

    	const block = {
    		c: function create() {
    			t = text("Выберите картинку как обложку для контента");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(55:0) <FormText color=\\\"muted\\\">",
    		ctx
    	});
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<FileCover> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(summary, file$1, 36, 2, 579);
    			add_location(details, file$1, 35, 0, 567);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			if (if_block) if_block.c();
    			add_location(div, file, 42, 0, 966);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
